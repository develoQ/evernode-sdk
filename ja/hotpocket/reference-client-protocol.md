...
### User challenge
When a user establishes a WebSoket connection to HotPocket, a user challenge is sent to the user from HotPocket. This message includes the HotPocket version, the running smart contract's id, the running smart contract's version, and a user challenge hex string.
```
    {
